...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Thêm chi tiết tỉnh</h1>
            </div>
        </div>
        <!--/.row-->
        <div class="row">
            <div class="col-xs-6 col-md-12 col-lg-12">
                <form class="col-sm-8 form-horizontal col-sm-offset-2" method="POST" action="">
                    @csrf
                    <h3><b>Thêm chi tiết tỉnh</b></h3>
                    <div class="form-group">
                      <label for="mst" class="col-sm-2 control-label">Đối tượng gán mã</label>
                      <div class="col-sm-8">
                        <input name="dt_gan_ma" type="text" class="form-control" id="mst" placeholder="Đối tượng gán mã">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <div class="form-group">
                                    <label class="col-sm-2 control-label">Tỉnh</label>
                                    <div class="col-sm-8">
                                        <input name="id_tinh" type="text" class="form-control input_tinh" placeholder="Tỉnh" autocomplete="off">
