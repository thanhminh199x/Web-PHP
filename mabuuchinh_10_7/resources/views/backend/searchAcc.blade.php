    ...
    <div class="row">
        <div class="col-xs-12 col-md-12 col-lg-12">
            ...
            <div class="panel panel-primary">
                <div class="panel-heading" style="text-align: center;"><b><i class="fas fa-search"></i> TÌM KIẾM TÀI KHOẢN</b></div>
                <div class="panel-body">
                    <div class="bootstrap-table">
                        ...
                        <div style="margin: 10px 0;"><b>Kết quả tìm kiếm : </b><span style="color: red;"><b>{{count($data)}}</b></span></div>
